...
namespace Web.Controllers
{
    public class LivroesController : Controller
    {
        ...
        public LivroesController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Livro != null ? 
                          ...
                          Problem("Entity set 'Context.Livro'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Book")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Book")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
